...
```solidity
    ...
    struct PBMToken {
        ...
        uint256 faceValue;
        // Token will be rendered useless after this time (expressed in number of seconds since 1st January 1970).
        uint256 expiry;
...
/// a merchant is anyone who is providing permitted goods or services and is hence deemed to be able to unwrap a PBM Token.
...
interface PBMRC1_TokenReceiver {
    /**
        ...
        @dev An PBM smart contract MUST call this function on the token recipient contract, at the end of an `unwrap` if the
...
It is recommended to adopt a token standard that is compatible with ERC-20. Examples of such tokens will be ERC-777, ERC-1363. ERC-20 however remains the most used as a result of the high degree of confidence in its security and simplicity.
